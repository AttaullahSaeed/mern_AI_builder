...
const AuthPage = ({ mode }) => {
  ...
  // Context se login aur register functions extract kiye
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  required
                  className="w-full pl-2 pr-10 py-2 border-b border-zinc-200 focus:outline-none focus:border-zinc-950 text-sm text-zinc-900 bg-transparent placeholder-zinc-300 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-2 text-zinc-400 hover:text-zinc-600 transition-colors p-1"
                >
                  {showPassword ? (
